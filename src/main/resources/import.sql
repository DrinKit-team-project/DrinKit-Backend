...
INSERT INTO menu(id, created_date, modified_date, calories, category, deleted, description, en_name, kr_name, review_count, total_ratings, cafe_id) values (1, 20180809081828, null, 238, "coffee", false, "basic_coffee", "americano", "아메리카노", 0, 0.0, 1);
INSERT INTO menu(id, created_date, modified_date, calories, category, deleted, description, en_name, kr_name, review_count, total_ratings, cafe_id) values (2, 20180810081828, null, 238, "coffee", false, "basic_coffee", "latte", "라떼", 0, 0.0, 1);
INSERT INTO menu(id, created_date, modified_date, calories, category, deleted, description, en_name, kr_name, review_count, total_ratings, cafe_id) values (3, 20180813081828, null, 238, "coffee", false, "basic_coffee", "cappuchino", "카푸치노", 0, 3.0, 1);
INSERT INTO menu(id, created_date, modified_date, calories, category, deleted, description, en_name, kr_name, review_count, total_ratings, cafe_id) values (4, 20180730081828, null, 238, "non-coffee", false, "basic_coffee", "chocolet", "초콜렛", 0, 4.0, 1);
INSERT INTO menu(id, created_date, modified_date, calories, category, deleted, description, en_name, kr_name, review_count, total_ratings, cafe_id) values (5, 20180504081828, null, 238, "non-coffee", false, "basic_coffee", "milk", "우유", 0, 5.0, 1);
